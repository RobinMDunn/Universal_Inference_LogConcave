# Benchmark fully nonparametric, random projections
...
parameter_file <- "sim_params/tab01_fully_NP_randproj_params.csv"
line_number <- 1
...
results <- data.table(Method = "Fully nonparametric, random projections",
...
fwrite(results, file = paste0("data/tab01_fully_NP_randproj_",
                              line_number, ".csv"))
