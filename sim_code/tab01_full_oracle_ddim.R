...
parameter_file <- "sim_params/tab01_full_oracle_ddim_params.csv"
line_number <- 1
...
results <- data.table(Method = "Full oracle, d-dim",
...
fwrite(results, file = paste0("data/tab01_full_oracle_ddim_",
                              line_number, ".csv"))