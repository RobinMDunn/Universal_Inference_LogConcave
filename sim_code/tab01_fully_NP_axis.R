# Benchmark fully nonparametric, axis-aligned projections
...
parameter_file <- "sim_params/tab01_fully_NP_axis_params.csv"
line_number <- 1
...
results <- data.table(Method = "Fully nonparametric, axis-aligned projections",
...
fwrite(results, file = paste0("data/tab01_fully_NP_axis_",
                              line_number, ".csv"))
